...
- Направления "🌍": топ-3, каждая страна на новой строке, формат "🏳Страна X зак / X тур" (orders и tourists).
- Продукты 📦: каждая строка отдельно. emoji 🏨 Пакет, 🏩 Отель, ✈️ Перелёт; показывай orders и tourists.
