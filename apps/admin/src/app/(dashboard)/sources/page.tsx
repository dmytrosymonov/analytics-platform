...
export default function SourcesPage() {
  ...
  const credentialFields: Record<string, { key: string; label: string; type?: string }[]> = {
    ...
    gto_comments: [{ key: 'api_key', label: 'API Key (same as GTO)', type: 'password' }, { key: 'base_url', label: 'Base URL (default: https://api.gto.ua/api/private)' }],
    ...
    youtrack_progress: [{ key: 'youtrack_base_url', label: 'YouTrack Base URL' }, { key: 'youtrack_token', label: 'Permanent Token', type: 'password' }, { key: 'youtrack_project', label: 'Project Short Name (optional)' }],
  };
