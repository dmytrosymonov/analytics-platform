...
- **Заказы** (`/orders_list`): всего, подтверждённые (CNF), отменённые (CNX), в ожидании; процент отмен, заказы по дням, топ компании
- **Платежи** (`/payments_list`): входящие и исходящие отдельно; выручка по валютам, нетто, средний платёж
...
Документация актуальна на: **27 марта 2026**
